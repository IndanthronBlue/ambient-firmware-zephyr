...
app_state_t app_state = {
	...
	.infer_last_rms = 0.0f,
	.infer_avg_rms = 0.0f,
	.infer_avg_rms_uplink = 0.0f,
	.infer_label_counts_window = {0},
	.infer_label_counts_uplink = {0},
